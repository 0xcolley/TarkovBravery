...
def generate_sql_insert(json_file_path):
    ...
    for item in items:
        ...
        sql_insert_statements.append(f"INSERT INTO Backpacks (name, image) VALUES ('{name}', '{image}');")
...
def main():
    json_file_path = './item_jsons/backpack.json'
    sql_file_path = './out/backpacks.sql'
